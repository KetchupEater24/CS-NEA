...
class DecksPage(BasePage):
    def __init__(self, master, user_id, switch_page):
        ...
        # creates a main header container ("My Decks" title)
        ...
        # creates a variable to hold deck priority selection (default "All")
        self.deck_priority_input = ctk.StringVar(value="All")
        # makes a priority dropdown menu
        ...
        # trace_add listens for changes to search field or priority dropdown and calls update_deck_containers()
        ...
        # creates a buttons container and packs it with add and delete selected buttons
        ...
        # creates a separator between sidebar and main content area
        self.separator = ctk.CTkFrame(self.main_content, height=1, fg_color="#E5E7EB")
        self.separator.pack(fill="x", padx=30, pady=(20, 0))

        # makes the main_content area scrollable for displaying decks
    ...
    def update_deck_containers(self):
        # clears current deck containers
        ...
        # calculates avg_ef of each deck by totalling easiness factor for each card and dividing by number of cards
        ...
        # filters decks by priority (using avg_ef)
        ...
        # if there are no decks, displays a "No decks found" message
        ...
        # sorts decks using a bst (binary search tree) based on avg_ef (lowest to highest)
        ...
        # displays decks in a 3-column grid
        row, col = 0, 0
    ...
    def add_deck(self):
        # creates an add deck dialog and adds a new deck if a name is provided
    ...
    def edit_deck(self, deck_id):
        # makes an edit deck dialog for the selected deck
        db = Database()
    ...
    def delete_deck(self, deck_id):
        # asks for confirmation and deletes the selected deck
    ...
    def toggle_deck_selection(self, deck_id, is_selected):
        # toggles the selection state of a deck and updates the delete button state
        if is_selected:
    ...
    def delete_selected_decks(self):
        # deletes all selected decks after asking for confirmation
...
class DeckContainer(BaseContainer):
    def __init__(self, master, user_id, deck_id, deck_name, card_count, avg_ef, edit_callback, delete_callback):
        ...
        # creates a main content container for deck info and action buttons
        self.content = ctk.CTkFrame(self, fg_color="transparent")
        self.content.pack(fill="both", expand=True, padx=20, pady=20)

        # creates an info frame to display deck details (name, card count, review count, priority)
        ...
        # creates a label to display available for review count
        db = Database()
        ...
        # creates a buttons container for edit and delete actions (if callbacks are provided)
        ...
        # creates a single-selection checkbox at the top right to toggle selection state
    ...
    def toggle_selection(self, event=None):
        # makes a method to toggle selection state if a click event (not directly on the checkbox) occurs
        if event and event.widget == self.checkbox:
            return
        ...
        # updates the parent's selection state directly
        self.master.master.toggle_deck_selection(self.deck_id, self.selected)
        self.configure(fg_color="#F5F3FF" if self.selected else "white")

    def on_checkbox_toggle(self):
        # makes a method to handle checkbox toggle, updating selection state and parent's selection
