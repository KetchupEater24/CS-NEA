...
class DeckContainer(BaseContainer):
    # initialises deck container with master, deck id, deck name, card count, selection, edit and delete callbacks
    ...
    # toggles selection state when container is clicked
