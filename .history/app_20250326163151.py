...
class DecksPage(BasePage):
    def __init__(self, master, user_id, switch_page):
        ...
        # header frame: container for the page title and filters
        ...
        # trace changes in search and filter to update the deck list
        ...
        # buttons frame: holds the add button and delete selected button
        ...
        # separator: visual divider below the header
