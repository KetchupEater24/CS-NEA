...
class CardContainer(BaseContainer):
    ...
    def __init__(self, master, card_id, question, answer, edit_callback, delete_callback, ef, user_id):
        ...
        # builds a label for the question text
        ctk.CTkLabel(
            self.card_container,
            text=question,
            font=("Inter", 16, "bold"),
        ...
        # builds a label for the answer text
        ctk.CTkLabel(
            self.card_container,
            text=answer,
            font=("Inter", 14),
        ...
        # builds a priority indicator based on ef
        if self.ef < 2.0:
            self.priority_text = "High Priority"
            self.color = "red"
        elif self.ef < 2.5:
        ...
        # builds a buttons container (Edit/Delete) and packs them to display on screen
