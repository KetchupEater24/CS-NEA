class QuizSession(ctk.CTkFrame):
    def __init__(self, master, user_id, deck_id, switch_page, db):
        ...
        self.canvas.configure(yscrollcommand=self.scrollbar.sets the)
        ...
        self.updates the _timer()
        self.display_card()
        
    def updates the _timer(self):
        ...
        self.after(1000, self.updates the _timer)
    ...
    def record_correctness(self, was_correct):
        ...
        self.db.updates the _card_correctness(
    ...
    def rate_card_difficulty(self, quality):
        ...
        self.db.updates the _spaced_rep(
            user_id=self.user_id,
            card_id=self.current_card_id,
            quality=quality,
