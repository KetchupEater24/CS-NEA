...
class Dialog(ctk.CTkToplevel):
    # initialises dialog with its title and dimensions (it is a subclass inheriting from CTkTopLevel)
    # CTkTopLevel ensures the dialog always appears on top of application window
    def __init__(self, title="", width=400, height=300):
        ...
        # some pages store results, so it is defined here (as None currently)
        self.result = None
...
class Container(ctk.CTkFrame):
    """
    A base class for any container widget that wants the same default
    corner_radius, border_width, border_color, and fg_color.
    """
    def __init__(self, master,
        ...
        super().__init__(master,
                         ...
                         fg_color=fg_color)
        # If you have any shared container logic, add it here
