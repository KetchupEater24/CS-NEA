...
class DecksPage(BasePage):
    ...
    def __init__(self, master, user_id, switch_page):
        ...
        # main header container ("my decks")
        ...
        # variable to hold deck priority selection (default "all")
        ...
        # update deck list when search or priority changes
        ...
        # buttons container for add and delete selected
    ...
    # updates the list of decks displayed on the page
