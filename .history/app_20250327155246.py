...
class SettingsPage(BasePage):
    ...
    def __init__(self, master, user_id, switch_page, db):
        ...
        # create header frame in the main content area
        header_frame = ctk.CTkFrame(self.main_header_content, fg_color="transparent")
        ...
        # create main content area (non-scrollable)
        ...
        # create settings container (holds the form)
        ...
        # add email label and entry (pre-populated with current email)
        ctk.CTkLabel(
            self.settings_container,
            text="Email",
            font=("Inter", 14, "bold"),
        ...
        # add username label and entry (pre-populated with current username)
        ctk.CTkLabel(
            self.settings_container,
            text="Username",
            font=("Inter", 14, "bold"),
