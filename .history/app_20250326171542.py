...
class DecksPage(BasePage):
    ...
    def toggle_deck_selection(self, deck_id, is_selected):
        ...
        self.delete_btn.configure(state="normal" if self.selected_decks else "disabled")
...
class DeckContainer(BaseContainer):
    def __init__(self, master, deck_id, deck_name, card_count, selection_callback, avg_ef, edit_callback, delete_callback):
        ...
        self.selection_callback = selection_callback  # callback for handling selection (used to get user_id)
        self.selected = False
        self.avg_ef = avg_ef
        ...
        # frame to display deck information on the left side
        ...
        # get available for review count from database; note: using __self__ to access user_id from the callback instance
        db = Database()
        ...
        # single-selection checkbox at the top right to indicate selection status
        ...
        self.checkbox.place(relx=1.0, rely=0.0, anchor="
