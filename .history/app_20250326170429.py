...
class DecksPage(BasePage):
    ...
    # adds a deck to the database, and updates decks displayed
    def add_deck(self):
        ...
        if new_deck_name:
            ...
            if deck_id:
                self.update_deck_list()
                if hasattr(self, 'sidebar'): # also updates deck list displayed in sidebar
                    self.sidebar.update_deck_list()

    # allows to edit a deck name and updates deck list
    ...
    # adds selected decks to selected_decks
