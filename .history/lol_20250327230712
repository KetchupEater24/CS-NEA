// CROSS TABLE PARAMETERISED SQL QUERY
...
// GRAPH TRAVERSAL (BINARY SEARCH TREE)
CLASS DECK_NODE
...
// LIST OPERATIONS (MERGE SORT ALGORITHM)
...
// RECURSIVE ALGORITHM (MERGE SORT SPLIT)
...
// COMPLEX USER-DEFINED ALGORITHM (SPACED REPETITION SCHEDULING)
...
// DYNAMIC GENERATION OF OBJECTS (UPDATING DECK LIST)
FUNCTION UPDATE_DECK_LIST()
    ...
    FOR EACH NODE IN SORTED_DECKS DO
        CREATE DECK_CONTAINER OBJECT WITH NODES DATA
...
// MULTI-DIMENSIONAL ARRAYS (GRID LAYOUT)
...
// DICTIONARIES (FETCHING USER DATA)
