...
class EditCardDialog(BaseDialog):
    ...
    def save_card(self):
        ...
        # in ("1.0", "end"), the 1 means start at the first line and the 0 means start at the first character of this line
        # then "end" means retrieve all text from the first character to the last character
