...
class DecksPage(BasePage):
    # initialise decks page as subclass of basepage (inheritance)
    def __init__(self, master, user_id, switch_page):
        ...
        self.header_title = ctk.CTkLabel(header_frame, text="My Decks", font=("Inter", 24, "bold"), text_color="black")
        ...
        self.deck_search_entry_field = ctk.CTkEntry(
            filter_frame, textvariable=self.deck_search_input,
        ...
        # trace_add listens for any writing operation to search area or selection on priority dropdown and calls update_deck_list accordingly
        ...
        # above is all the styling code required for the decks page
