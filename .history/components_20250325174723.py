...
class BasePage(ctk.CTkFrame):
    # initialises the base page as a subclass of CTkFrame (inheritance)
...
class BaseComponents:
    ...
    # creates an option menu for dropdown selections (e.g., priority selection, graph type options)
    @staticmethod
    ...
    # creates a label with base styling
    @staticmethod
