...
class DeckContainer(BaseContainer):
    def __init__(self, master, deck_id, deck_name, card_count, avg_ef, edit_callback, delete_callback, user_id):
        ...
        # Display available count for review
        db = Database()
        due_count = db.get_available_for_review(self.user_id, deck_id)
        ctk.CTkLabel(
            self.info_frame,
        ...
        # Removed single-selection checkbox and related selection callback functionality.
