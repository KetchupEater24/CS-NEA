...
class DecksPage(BasePage):
    ...
    def __init__(self, master, user_id, switch_page):
        ...
        ctk.CTkLabel(header, text="My Decks", font=("Inter", 24, "bold"), text_color="black").pack(side="left")
        ...
        # create buttons container at top right of decks page and pack it with the add and delete selected buttons
