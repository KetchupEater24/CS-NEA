...
class DecksPage(BasePage):
    def __init__(self, master, user_id, switch_page):
        ...
        # separator: visual divider below the header to seperate it from the decks_frame below
        self.separator = ctk.CTkFrame(self.main_header_content, height=1, fg_color="#DC2626")
