        ...
        self.interval_help = ctk.CTkLabel(
            ...
            text=(
               "Choose how well you recalled the answer:\n"
                " • Very Hard → review in 2 minutes   (you barely remembered it; quick refresh)\n"
                " • Hard → review in 6 minutes         (you struggled but got it; see it soon)\n"
                " • Medium → review in 10 minutes      (you were okay; revisit shortly)\n"
                " • Easy → review tomorrow (1 day)     (you recalled easily; check tomorrow)\n"
                " • Very Easy → review in 3 days       (you remembered effortlessly; give it more time)\n"
                "\n"
                "For example, pressing “Very Hard” will queue the card again in just 2 minutes.\n"
            ),
            font=("Inter", 12),
            text_color="#4B5563",
            wraplength=600,
