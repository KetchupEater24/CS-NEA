...
class CardsPage(BasePage):
    def __init__(self, master, user_id, deck_id, switch_page):
        ...
        self.card_search_input.trace_add("write", lambda *args: self.display_cards())
        self.card_priority_filter_selection.trace_add("write", lambda *args: self.display_cards())
