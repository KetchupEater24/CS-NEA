...
class QuizSession(ctk.CTkFrame):
    def __init__(self, master, user_id, deck_id, switch_page, db):
        ...
        self.interval_help = ctk.CTkLabel(
            ...
            text=(
                ...
                " • Very Hard → review in 2 minutes   (you barely remembered it; quick reinforcement)\n"
                " • Hard → review in 6 minutes         (you struggled; repeat soon to cement it)\n"
                " • Medium → review in 10 minutes      (you remembered with effort; revisit shortly)\n"
                " • Easy → review tomorrow (1 day)     (you recalled it comfortably; check again tomorrow)\n"
                " • Very Easy → review in 3 days       (you remembered effortlessly; space out the next review)\n"
                "\n"
                ...
                "\n"
                "For example, pressing “Very Hard” will queue the card to reappear in just 2 minutes.\n"
    ...
    def show_summary(self):
        ...
        summary_frame = ctk.CTkFrame(self.master, fg_color="#F3F4F6", corner_radius=0)
